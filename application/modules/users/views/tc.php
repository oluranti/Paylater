...
<body>
<p><strong>CREDIT FACILITY AGREEMENT</strong><br />
  This Agreement made this <strong><?php echo $day; ?> day of <?php echo $month; ?> <?php echo $year; ?></strong> applies  to and regulates the provision of credit facilities advanced by <strong>One Credit Limited</strong> (&quot;The Lender&quot;) to <strong><?php echo $title; ?></strong> <strong><?php echo $firstname; ?> <?php echo $lastname; ?> of <?php echo $address; ?> (the Borrower)</strong>. The terms  governing this Agreement are contained herein:</p>
<p>WHEREAS</p>
<ul>
  <li>One Credit Limited is a company registered with  the Corporate Affairs Commission established under The Companies and Allied Matters  Act, 2004</li>
</ul>
<ul>
  <li>One Credit is the proprietor and owner of the  product - <strong>PayLater&reg;</strong></li>
</ul>
<ul>
  <li><strong>PayLater&reg;</strong> is an open-end credit plan offered by One Credit Limited (&quot;the  Lender&quot;). </li>
</ul>
<ul>
  <li>The Borrower intends to make online purchase(s)  using the PayLater payment option</li>
</ul>
<ul>
  <li>The Borrower and the Lender hereby agree to be  bound by the terms set out herein in this Agreement </li>
</ul>
<p><strong>1. DEFINITION</strong>:<br />&quot;<em>Parties</em>&quot;  to this agreement are: &quot;<em>You</em>&quot;,  &quot;<em>your</em>&quot; and &quot;<em>Borrower</em>&quot; mean the person who  applied for this <br />
  Account and agrees to this Agreement.</p>
<p><em>&quot;We&quot;, &quot;us&quot; and  &quot;our&quot; mean &quot;Lender&quot;</em>, and following an assignment, any person,  company or bank to whom the rights and/or obligations of the Lender have been  assigned</p>
<p>&quot;<em>Merchant&quot; &quot;our Partner</em>&quot; means any  person/company/organization who is duly accredited, acknowledged and authorizes  as participatory in the PayLater payment option.</p>
<p>&quot;<em>Account</em>&quot;  means the Borrower&rsquo;s account with the Lender </p>
<p>&quot;<em>Disbursement Date</em>&quot; means the date the  Lender made payment for the purchase on behalf of the Borrower </p>
<p>&quot;<em>Payment Due  Date</em>&quot; means 30 days after the purchase was made</p>
<p>&quot;<em>Credit Limit</em>&quot; means the maximum credit  available to the Borrower on opening the account with the Lender</p>
<p><em>&quot;Loan&quot;</em> means the amount utilized by the  customer to purchase on the Merchant&rsquo;s site </p>
<p><strong>2. CUSTOMER CONSENT</strong>:<br />
  By ticking the <em>&quot;I agree to the Agreement&quot;</em>, on  the application form, which you hereby adopt as your electronic signature, you  consent and agree that: </p>
<ul>
...
<ul>
  <li>To pay a Late Fee and Return Cheque Fee, as  provided in this Agreement.</li>
</ul>
<ul>
...
<p>The Lender agrees  that the Borrower may communicate with us by sending notices, messages, alerts  and statements in relation to this Agreement in the following manner:</p>
<ul>
  <li>To the physical address of the Lender; and</li>
</ul>
<ul>
  <li>By delivery to any email address provided during  the application process.</li>
</ul>
...
<p>IN WITNESSES of which the Borrower  has executed this agreement and the duly authorized representatives of the Lender  has executed same hereto the day and year first above written.</p>
</body>
</html>